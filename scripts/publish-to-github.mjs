...
В релизе ${tag} полностью решена проблема сохранения старых/удаленных серверов («призраков»), добавлена динамическая валидация папок серверов на диске и кнопка моментальной очистки несуществующих серверов в 1 клик.

### ⚡ Что нового в ${tag}:
- 🧹 **Очистка старых и несуществующих серверов**: автоматическая фильтрация удаленных папок и устаревших демо-путей из localStorage при запуске.
- 🔍 **Живая проверка диска**: статус каждого сервера в Менеджере («🟢 ГОТОВ», «🟡 НЕТ RUSTDEDICATED.EXE», «🔴 ПАПКА НЕ НАЙДЕНА»).
- 🚀 **Кнопка «🧹 Очистить несуществующие»**: мгновенно удаляет из списка все серверы, папки которых были удалены с диска.
- 🎯 **Умное авто-сканирование**: сканирует локальные диски и рабочие директории на реальные установленные серверы Rust.
- 🗑️ **Снято ограничение на удаление**: теперь можно удалять любые ненужные серверы из списка без ограничений.
- ⚡ **Идеальное In-App обновление**: скачивание ядра через \`original-fs\` без перехода в браузер.
