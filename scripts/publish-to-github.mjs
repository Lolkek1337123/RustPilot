...
Релиз v1.0.5 включает проверенный установщик In-App обновлений, полную поддержку протокола Rust 2633 и Carbon 2.0.259.

### ⚡ Что нового в ${tag}:
- ⚡ **Идеальное In-App обновление**: скачивание и бесшовное применение ядра программы прямо в окне приложения за пару секунд.
- 🛠️ **Абсолютно надёжный установщик**: ликвидированы любые зависания консоли на Windows, процесс установки полностью автоматизирован.
...
- 🔄 **Кнопка «🔄 Обновить SteamCMD»**: мгновенная проверка и обновление выделенного сервера.
- 🌟 Новый неоновый бейдж **${tag} PRO** в шапке панели.

---

### 📥 Как обновиться:
- **Существующие пользователи**: просто откройте приложение — оно предложит обновиться автоматически, либо нажмите кнопку **«⚡ Скачать и обновить прямо сейчас»** в настройках!
